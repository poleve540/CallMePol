...
Now, if you're lucky enough to get the same item multiple times in a row, a style meter will appear! Every time the same item appears, the style meter from "Combo", to "Nice", Great Going and finally Stylish.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE4MjE4NDE5MzAsMTE5MzgyNTkxMiw0MT
